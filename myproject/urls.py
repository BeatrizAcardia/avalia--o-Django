...
urlpatterns = [
    path('admin/', admin.site.urls), # URL para a administração dosite
    path('', views.index, name='index'), # URL para a página inicial
    path('signup/', views.signup, name='signup'), # URL para a página de inscrição
    path('inscriptions/', views.view_inscriptions, name='view_inscriptions'), # URL para a página de visualização das inscrições
]
if settings.DEBUG:
